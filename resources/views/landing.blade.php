                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-12 px-0">
                                                            <div class="feature-logos mt-5">
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/1.png') }}">
                                                                    <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/2.png') }}">
                                                                    <h5 class="mt-3 text-white">HTML5</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/3.png') }}">
                                                                    <h5 class="mt-3 text-white">JQuery</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/4.png') }}">
                                                                    <h5 class="mt-3 text-white">Sass</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/5.png') }}">
                                                                    <h5 class="mt-3 text-white">Gulp</h5>
                                                                </div>
                                                                <div class="slide">
                                                                    <img src="{{ asset('images/landing/web/6.png') }}">
...
<!-- COUNTERS JS -->
<script src="{{ asset('js/counters/counterup.min.js') }}"></script>
<script src="{{ asset('js/counters/waypoints.min.js') }}"></script>
<script src="{{ asset('js/counters/counters-1.js') }}"></script>

<!-- Perfect SCROLLBAR JS -->
<script src="{{ asset('js/owl-carousel/owl.carousel.js') }}"></script>
<script src="{{ asset('js/owl-carousel/slider.js') }}"></script>

<!-- Star Rating Js -->
<script src="{{ asset('js/rating/jquery-rate-picker.js') }}"></script>
<script src="{{ asset('js/rating/rating-picker.js') }}"></script>

<!-- Star Rating-1 Js -->
<script src="{{ asset('js/ratings-2/jquery.star-rating.js') }}"></script>
<script src="{{ asset('js/ratings-2/star-rating.js') }}"></script>
